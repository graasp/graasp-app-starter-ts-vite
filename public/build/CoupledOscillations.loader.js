function createUnityInstance(e, r, n) {
  function o(e, n) {
    if (!o.aborted && r.showBanner)
      return 'error' == n && (o.aborted = !0), r.showBanner(e, n);
    switch (n) {
      case 'error':
        console.error(e);
        break;
  ...
  function t(e) {
    ...
    if (
      (o.startsWith(n) && (o = o.substring(n.length)),
      (n += '\n' + o.trim()),
  ...
  document.addEventListener('webkitfullscreenchange', function (r) {
    ...
    n === e
      ? e.style.width &&
        ...
        (e.style.width = '100%'),
        (e.style.height = '100%'))
      : h && ((e.style.width = h), (e.style.height = p), (h = ''), (p = ''));
  });
  var b = {
    Module: c,
